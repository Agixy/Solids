...
{
    public class Pyramid3 : Pyramid
    {
        private readonly Triangle _baseTriangle;

        public Pyramid3(double height, double a, double b, double c) : base(height)
        {
        ...
        {
            return _baseTriangle.Equals((other as Pyramid3)?._baseTriangle);
        }
    }
}
